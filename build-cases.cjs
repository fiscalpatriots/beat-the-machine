/* build-cases.cjs
   ...
   index.html fetches cases/halyard-v4.json and cases/brightwater-v4.json at load.
...
function check(c, name) {
  ...
  if (c.mode === "assessment") {
    /* From brightwater-v4 every assessment line tests a named cause. A silent line has no cause
...
var two = load("brightwater-v4.json");
